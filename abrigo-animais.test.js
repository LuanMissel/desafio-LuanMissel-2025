...
describe('Abrigo de Animais', () => {
 ...
 test('Deve respeitar o limite de 3 animais por pessoa', () => {
    const resultado = new AbrigoAnimais().encontraPessoas(
      'LASER,RATO,BOLA,NOVELO,CAIXA', 'BOLA,RATO,SKATE', 'Bebe,Rex,Bola,Fofo');
  ...
  test('Deve aplicar a regra especial do jabuti Loco', () => {
    const resultado = new AbrigoAnimais().encontraPessoas(
      'SKATE,BOLA', 'RATO,NOVELO,LASER,SKATE', 'Loco');
